...
* (Windows)
    ...
    java -cp ./target/sidechains-sdk-simpleapp-0.12.0-RC1.jar;./target/lib/* io.horizen.examples.SimpleApp <path_to_config_file>
    ```
* (Linux)
    ```
...
* (Windows)
    ...
    java -cp ./target/sidechains-sdk-evmapp-0.12.0-RC1.jar;./target/lib/* io.horizen.examples.EvmApp <path_to_config_file>
    ```
* (Linux)
    ```
    cd ./Sidechains-SDK/examples/account/evmapp
    java -cp ./target/sidechains-evmapp-0.12.0-RC1.jar:./target/lib/\* io.horizen.examples.EvmApp <path_to_config_file>
    ```
