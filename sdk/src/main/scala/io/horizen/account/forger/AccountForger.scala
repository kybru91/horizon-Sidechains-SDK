...
object AccountForgerRef {
  def props(settings: SidechainSettings,
    ...
    val forgeMessageBuilder: AccountForgeMessageBuilder = new AccountForgeMessageBuilder(mainchainSynchronizer, companion, timeProvider, params, settings.websocketClient.allowNoConnectionInRegtest)
