...
object ForgerRef {
  def props(settings: SidechainSettings,
    ...
    val forgeMessageBuilder: ForgeMessageBuilder = new ForgeMessageBuilder(mainchainSynchronizer, companion, timeProvider, params, settings.websocketClient.allowNoConnectionInRegtest)
