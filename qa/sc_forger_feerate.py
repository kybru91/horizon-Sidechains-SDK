...
class SCForgerFeerate(SidechainTestFramework):
    ...
    def sc_setup_chain(self):
        ...
        network = SCNetworkConfiguration(SCCreationInfo(mc_node, creation_amount=100, withdrawal_epoch_length=self.sc_withdrawal_epoch_length), sc_node_configuration)
    ...
    def run_test(self):
        ...
        check_box_balance(sc_node, Account("", sc_address), "ZenBox", 3, 60)
